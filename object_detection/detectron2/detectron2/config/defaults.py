...
# Hierarchical focal loss enabled
_C.MODEL.RETINANET.HIERARCHICAL_FOCAL_LOSS = False
_C.MODEL.RETINANET.HIERARCHICAL_LOSS_WEIGHTS = None
_C.MODEL.RETINANET.HIERARCHICAL_INCLUDE_ROOT = False
_C.MODEL.RETINANET.MAX_HIERARCHY_LEVELS = None
...
_C.TEST.EVAL_HIERARCHICAL = False
_C.TEST.TEST_WITH_OUTPUT_JSON = False
